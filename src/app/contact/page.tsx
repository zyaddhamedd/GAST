        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 md:gap-20 items-start">
          ...
          <div className="space-y-8 md:space-y-12 lg:sticky lg:top-24">
            ...
            <div className="grid grid-cols-2 md:grid-cols-2 gap-6 md:gap-8">
              {[
                { icon: <MapPin className="w-5 h-5 md:w-7 md:h-7" />, title: "العنوان", content: "مول علي الدين،مبني ب،ميدان ليله, قسم ثان 6 أكتوبر، محافظة الجيزة", sub: "مدينة 6 أكتوبر" },
                { icon: <Phone className="w-5 h-5 md:w-7 md:h-7" />, title: "الهاتف", content: "01005708036", sub: "اتصال مباشر" },
                { icon: <Mail className="w-5 h-5 md:w-7 md:h-7" />, title: "البريد", content: "info@gast-eg.com", sub: "للمراسلات" },
            ...
            <div className="flex flex-col sm:flex-row gap-5 pt-4">
              <a href="https://wa.me/201005708036" className="flex-1 flex items-center justify-center gap-4 bg-[#25d366] text-white py-5 px-8 rounded-2xl font-extrabold text-xl hover:scale-[1.03] active:scale-[0.97] transition-all shadow-xl shadow-green-500/20 group">
                <MessageCircle className="w-7 h-7 group-hover:animate-bounce" />
                تواصل عبر واتساب
              </a>
              <a href="tel:01005708036" className="flex-1 flex items-center justify-center gap-4 bg-brand-blue text-white py-5 px-8 rounded-2xl font-extrabold text-xl hover:scale-[1.03] active:scale-[0.97] transition-all shadow-xl shadow-brand-blue/20">
